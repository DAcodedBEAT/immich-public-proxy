    ...
    <html lang='en'>
      <head>
        ...
        <link
          type='text/css'
          rel='stylesheet'
          href={`/share/static/${ASSET_VERSION}/photoswipe-overrides.css`}
        />
      </head>
      <body>
        ...
        {props.showDownloadZip && (
          <div id='select-toolbar' hidden>
            ...
            <button id='select-all' class='toolbar-btn-text' type='button'>
              Select all
            </button>
            <button
              id='select-download'
